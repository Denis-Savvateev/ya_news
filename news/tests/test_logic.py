...
class TestCommentCreation(TestCase):
    """Тестирует логику создания комментария."""
...
class TestCommentEditDelete(TestCase):
    """Тестирует логику редактирования/удаления комментария."""
    ...
    def setUpTestData(cls):
        ...
        cls.news = News.objects.create(title='Заголовок', text='Текст')
        # Формируем адрес блока с комментариями, который
        # понадобится для тестов.
        # Адрес новости:
